...
volatile uint32_t *h2p_lw_switch_addr = NULL;
void led_blink(void){
	...
	while(1){
		alt_write_word(h2p_lw_led_addr,  alt_read_word(h2p_lw_switch_addr));
...
int main(int argc, char **argv){
	...
	h2p_lw_switch_addr= virtual_base + ( (uint32_t)(SWITCH_PIO_BASE));
